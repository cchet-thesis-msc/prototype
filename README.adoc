...
* link:openshift/README.adoc[Openshift] holds the documentation of the implemented resources, which manage
  a Openshift Project.
* link:services/README.adoc[Integration Services] holds the documentation of the implemented integration services.
