...
function deleteService() {
    ...
    oc delete configmap ${SERVICE_NAME}
    oc delete secret -l app=${SERVICE_NAME}
    oc delete pvc -l app=${SERVICE_NAME}

    ../mongodb/oc.sh deleteService ${SERVICE_NAME_MONGO}
    ../elasticsearch/oc.sh deleteService ${SERVICE_NAME_ELASTIC}
}
